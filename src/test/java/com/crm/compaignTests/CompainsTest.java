...
public class CompainsTest {
	...
	public void createContactWithOrgTest() throws Throwable
	{
		...
		String ProNameRan=ProName+" "+random;
		...
		/*Step 5: click on create products btn*/
		driver.findElement(By.xpath("//img[@src='themes/softed/images/btnL3Add.gif']")).click();
		
		/*Step 6: enter mandatory fields and save*/
		driver.findElement(By.xpath("//input[@class='detailedViewTextBox' and @name='productname']")).sendKeys(ProNameRan);
